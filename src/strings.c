...
const u8 gText_Lv50[] = _("Entry Mode");
const u8 gText_OpenLevel[] = _("Hard Mode");
...
const u8 gText_Lv50_3[] = _("Entry Mode");
const u8 gText_OpenLevel2[] = _("Hard Mode");
...
const u8 gText_OpenLevel3[] = _("Hard Mode");
...
const u8 gText_Lv502[] = _("Entry Mode");
const u8 gText_OpenLv[] = _("Hard Mode");
...
ALIGNED(4) const u8 gText_RecordsLv50[] = _("Entry Mode");
ALIGNED(4) const u8 gText_RecordsOpenLevel[] = _("Hard Mode");
...
const u8 gText_SideQuestName_3[] = _("The Great Pokédex");
const u8 gText_SideQuestName_4[] = _("Fragmented Memories");
const u8 gText_SideQuestName_5[] = _("Courier Service");
const u8 gText_SideQuestName_6[] = _("Origins");
const u8 gText_SideQuestName_7[] = _("Side Quest 7");
const u8 gText_SideQuestName_8[] = _("Pyramid Plunder");
const u8 gText_SideQuestName_9[] = _("Dream Research");
const u8 gText_SideQuestName_10[] = _("Good Night's Sleep");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Challenge gym leaders and obtain \nall 8 badges!\nReward: Rainbow Ticket");
const u8 gText_SideQuestDesc_2[] = _("Seek out the legendary Pokémon\nin Hoenn region.\nReward: Key to Heavens");
const u8 gText_SideQuestDesc_3[] = _("Fill up the pokédex.\nReward: Legend Plate");
const u8 gText_SideQuestDesc_4[] = _("Investigate the strange\n phenomena of past repeating.\nReward: ???");
const u8 gText_SideQuestDesc_5[] = _("Deliver Devon's letter to Steven.\nReward: Moon Stone");
...
const u8 gText_SideQuestDoneDesc_1[] = _("You have obtained all 8 badges in Hoenn\nand can now challenge the Elite Four.");
const u8 gText_SideQuestDoneDesc_2[] = _("You have caught all legendary\nPokémon in the Hoenn region!");
const u8 gText_SideQuestDoneDesc_3[] = _("You have filled every page of\nthe Pokédex!");
const u8 gText_SideQuestDoneDesc_4[] = _("The incidence was solved and \nthe mastermind revealed.");
const u8 gText_SideQuestDoneDesc_5[] = _("Steven received the letter and\nrewarded you with Steel Wing TM.");
const u8 gText_SideQuestDoneDesc_6[] = _("You discovered the whereabouts\nof Mewtwo and battled Green.");
const u8 gText_SideQuestDoneDesc_7[] = _("Completed Quest 7");
const u8 gText_SideQuestDoneDesc_8[] = _("You mapped the depths of Vajra Pyramid.");
const u8 gText_SideQuestDoneDesc_9[] = _("You delivered the Abra\nto the researcher.");
const u8 gText_SideQuestDoneDesc_10[] = _("The girl can now sleep peacefully\nwith help of Pokémon!");
...
const u8 gText_SideQuestMap3[] = _("The world");
const u8 gText_SideQuestMap4[] = _("Multiple");
const u8 gText_SideQuestMap5[] = _("Granite Cave");
const u8 gText_SideQuestMap6[] = _("Faraway Island");
const u8 gText_SideQuestMap7[] = _("Map 7");
const u8 gText_SideQuestMap8[] = _("Vajra Pyramid");
const u8 gText_SideQuestMap9[] = _("Rustboro City");
const u8 gText_SideQuestMap10[] = _("Dewford Dojo");
...
const u8 gText_SideQuestMap31[] = _("Map 31");
const u8 gText_SideQuestMap32[] = _("Map 32");
const u8 gText_SideQuestMap33[] = _("Map 33");

const u8 gText_SubQuestMap1[] = _("Frostward Mountain");
const u8 gText_SubQuestMap2[] = _("New Mauville");
const u8 gText_SubQuestMap3[] = _("Mt. Chimney Depths");
const u8 gText_SubQuestMap4[] = _("Unknown Dungeon");
const u8 gText_SubQuestMap5[] = _("Faraway Island");
const u8 gText_SubQuestMap6[] = _("Thunder Plains");
const u8 gText_SubQuestMap7[] = _("Map 9");
const u8 gText_SubQuestMap8[] = _("Map 8");
const u8 gText_SubQuestMap9[] = _("Map 9");
const u8 gText_SubQuestMap10[] = _("Map 10");
const u8 gText_SubQuestMap11[] = _("Desert Ruins");
const u8 gText_SubQuestMap12[] = _("Island Cave");
const u8 gText_SubQuestMap13[] = _("Ancient Tomb");
const u8 gText_SubQuestMap14[] = _("Map 14");
const u8 gText_SubQuestMap15[] = _("Map 15");
const u8 gText_SubQuestMap16[] = _("Map 16");
const u8 gText_SubQuestMap17[] = _("Map 17");
const u8 gText_SubQuestMap18[] = _("Map 18");
const u8 gText_SubQuestMap19[] = _("Map 19");
const u8 gText_SubQuestMap20[] = _("Map 20");
const u8 gText_SubQuestMap21[] = _("Map 21");
const u8 gText_SubQuestMap22[] = _("Fogbound Cavern");
const u8 gText_SubQuestMap23[] = _("Verity Cavern");
const u8 gText_SubQuestMap24[] = _("Valor Cavern");
const u8 gText_SubQuestMap25[] = _("Map 25");
const u8 gText_SubQuestMap26[] = _("Map 26");
const u8 gText_SubQuestMap27[] = _("Map 27");
const u8 gText_SubQuestMap28[] = _("Map 28");
const u8 gText_SubQuestMap29[] = _("Map 29");
...
//subquests
const u8 gText_SubQuest1_Name1[] = _("Articuno");
const u8 gText_SubQuest1_Name2[] = _("Zapdos");
const u8 gText_SubQuest1_Name3[] = _("Moltres");
const u8 gText_SubQuest1_Name4[] = _("Mewtwo");
const u8 gText_SubQuest1_Name5[] = _("Mew");
const u8 gText_SubQuest1_Name6[] = _("Raikou");
const u8 gText_SubQuest1_Name7[] = _("Entei");
const u8 gText_SubQuest1_Name8[] = _("Suicune");
const u8 gText_SubQuest1_Name9[] = _("Lugia");
const u8 gText_SubQuest1_Name10[] = _("Ho-Oh");
const u8 gText_SubQuest1_Name11[] = _("Celebi");
const u8 gText_SubQuest1_Name12[] = _("Regirock");
const u8 gText_SubQuest1_Name13[] = _("Regice");
const u8 gText_SubQuest1_Name14[] = _("Registeel");
const u8 gText_SubQuest1_Name15[] = _("Latias");
const u8 gText_SubQuest1_Name16[] = _("Latios");
const u8 gText_SubQuest1_Name17[] = _("Kyogre");
const u8 gText_SubQuest1_Name18[] = _("Groudon");
const u8 gText_SubQuest1_Name19[] = _("Rayquaza");
const u8 gText_SubQuest1_Name20[] = _("Jirachi");
const u8 gText_SubQuest1_Name21[] = _("Deoxys");
const u8 gText_SubQuest1_Name22[] = _("Uxie");
const u8 gText_SubQuest1_Name23[] = _("Mesprit");
const u8 gText_SubQuest1_Name24[] = _("Azelf");
const u8 gText_SubQuest1_Name25[] = _("Dialga");
const u8 gText_SubQuest1_Name26[] = _("Palkia");
const u8 gText_SubQuest1_Name27[] = _("Heatran");
const u8 gText_SubQuest1_Name28[] = _("Regigigas");
const u8 gText_SubQuest1_Name29[] = _("Giratina");
const u8 gText_SubQuest1_Name30[] = _("Cresselia");
const u8 gText_SubQuest1_Name31[] = _("Manaphy");
const u8 gText_SubQuest1_Name32[] = _("Darkrai");
const u8 gText_SubQuest1_Name33[] = _("Shaymin");
...
const u8 gText_SubQuest1_Desc2[] = _("Zapdos had taken shelter in the depths\nof New Mauville.");
const u8 gText_SubQuest1_Desc3[] = _("Moltres had its nest in the depths of\nMt Chimney.");
const u8 gText_SubQuest1_Desc4[] = _("Mewtwo had peacefully slept inside\na Unknown Dungeon for a very long time.");
const u8 gText_SubQuest1_Desc5[] = _("Mew had been hiding on the Faraway\nIsland for a long time.");
...
const u8 gText_SubQuest1_Desc12[] = _("Regirock resided behind an ancient\puzzle inside the Desert Ruins.");
const u8 gText_SubQuest1_Desc13[] = _("Regice resided behind an ancient\puzzle inside the Island Cave.");
const u8 gText_SubQuest1_Desc14[] = _("Registeel resided behind an ancient\puzzle inside the Ancient Tomb.");
...
const u8 gText_SubQuest1_Desc22[] = _("Uxie accompanied me after a battle\ninside the Fogbound Cavern.");
const u8 gText_SubQuest1_Desc23[] = _("Mesprit accompanied me after a battle\ninside the Verity Cavern.");
const u8 gText_SubQuest1_Desc24[] = _("Azelf accompanied me after a battle\ninside the Valor Cavern.");
const u8 gText_SubQuest1_Desc25[] = _("Description Sub 25");
const u8 gText_SubQuest1_Desc26[] = _("Description Sub 26");
const u8 gText_SubQuest1_Desc27[] = _("Description Sub 27");
const u8 gText_SubQuest1_Desc28[] = _("Description Sub 28");
const u8 gText_SubQuest1_Desc29[] = _("Description Sub 29");

...
static void GetFrontierData(void)
{
    ...
    case FRONTIER_DATA_HEARD_BRAIN_SPEECH:
        gSpecialVar_Result = gSaveBlock1Ptr->frontier.battledBrainFlags & gFrontierBrainInfo[facility].battledBit[hasSymbol];
        break;
    }
}
...
static void SetFrontierData(void)
{
    ...
    case FRONTIER_DATA_RECORD_DISABLED:
        ...
        break;
    case FRONTIER_DATA_HEARD_BRAIN_SPEECH:
        gSaveBlock1Ptr->frontier.battledBrainFlags |= gFrontierBrainInfo[facility].battledBit[hasSymbol];
        break;
    }
}

...
enum FlagsVarsDebugMenu
{
    ...
    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_GAMECLEAR,
};
...
static void DebugAction_FlagsVars_GameClearOnOff(u8 taskId);
...
static const u8 sDebugText_FlagsVars_SwitchGameClear[] =        _("Toggle {STR_VAR_1}Game Clear OFF");
// Battle
...
static const struct ListMenuItem sDebugMenu_Items_FlagsVars[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_GAMECLEAR]   =   {sDebugText_FlagsVars_SwitchGameClear,    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_GAMECLEAR},
};
...
static void (*const sDebugMenu_Actions_Flags[])(u8) =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_GAMECLEAR]     = DebugAction_FlagsVars_GameClearOnOff,
};
...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_CATCHING:
            ...
            break;
    #endif
    case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_GAMECLEAR:

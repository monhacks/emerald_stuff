...
const struct Tileset gTileset_Desert_Pyramid =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Desert_Pyramid,
    .palettes = gTilesetPalettes_Desert_Pyramid,
...
const struct Tileset gTileset_Building_Woods =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Building_Woods,
    .palettes = gTilesetPalettes_Building_Woods,
    .metatiles = gMetatiles_Building_Woods,

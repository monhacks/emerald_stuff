...
{
    u16 ability = GetAbilityBySpecies(sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.abilityNum);
    PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), gAbilitiesInfo[ability].description, 4, 14, 0, 0);
}
...
static void BufferStat(u8 *dst, u8 statIndex, u32 stat, u32 strId, u32 align)
{
    ...
    {
        if (statIndex == gNaturesInfo[sMonSummaryScreen->summary.mintNature].statUp && gNaturesInfo[sMonSummaryScreen->summary.mintNature].statUp != gNaturesInfo[sMonSummaryScreen->summary.mintNature].statDown)
            StringAppend(txtPtr, sTextUpArrow);
        else if (statIndex == gNaturesInfo[sMonSummaryScreen->summary.mintNature].statDown && gNaturesInfo[sMonSummaryScreen->summary.mintNature].statUp != gNaturesInfo[sMonSummaryScreen->summary.mintNature].statDown)

...
static const u8 sMapsecToRegion[] = {
    ...
    [MAPSEC_ROUTE_4_POKECENTER] = REGION_HOENN,
    [MAPSEC_SHAMOUTI_ISLAND] = REGION_HOENN,
    [MAPSEC_RUGGED_ROAD] = REGION_HOENN,
    [MAPSEC_OLIVINE_CITY] = REGION_JOHTO,
    [MAPSEC_ROUTE_5] = REGION_HOENN,
    [MAPSEC_ROUTE_6] = REGION_HOENN,
    [MAPSEC_ROUTE_7] = REGION_HOENN,
    [MAPSEC_ROUTE_8] = REGION_HOENN,
    [MAPSEC_ROUTE_9] = REGION_HOENN,
    [MAPSEC_ROUTE_10] = REGION_HOENN,
    [MAPSEC_ROUTE_11] = REGION_HOENN,
    [MAPSEC_ROUTE_12] = REGION_HOENN,
    [MAPSEC_ROUTE_13] = REGION_HOENN,
    [MAPSEC_ROUTE_14] = REGION_HOENN,
    [MAPSEC_ROUTE_15] = REGION_HOENN,
    [MAPSEC_ROUTE_16] = REGION_HOENN,
    [MAPSEC_ROUTE_17] = REGION_HOENN,
    [MAPSEC_ROUTE_18] = REGION_HOENN,
    [MAPSEC_ROUTE_19] = REGION_HOENN,
    [MAPSEC_ROUTE_20] = REGION_HOENN,
    [MAPSEC_ROUTE_21] = REGION_HOENN,
    [MAPSEC_ROUTE_22] = REGION_HOENN,
    [MAPSEC_ROUTE_23] = REGION_HOENN,
    [MAPSEC_ROUTE_24] = REGION_HOENN,
    [MAPSEC_ROUTE_25] = REGION_HOENN,
    [MAPSEC_VIRIDIAN_FOREST] = REGION_HOENN,
    [MAPSEC_MT_MOON] = REGION_HOENN,
    [MAPSEC_S_S_ANNE] = REGION_HOENN,
    [MAPSEC_UNDERGROUND_PATH] = REGION_HOENN,
    [MAPSEC_UNDERGROUND_PATH_2] = REGION_HOENN,
    [MAPSEC_DIGLETTS_CAVE] = REGION_HOENN,
    [MAPSEC_KANTO_VICTORY_ROAD] = REGION_HOENN,
    [MAPSEC_ROCKET_HIDEOUT] = REGION_HOENN,
    [MAPSEC_SILPH_CO] = REGION_HOENN,
    [MAPSEC_POKEMON_MANSION] = REGION_HOENN,
    [MAPSEC_KANTO_SAFARI_ZONE] = REGION_HOENN,
    [MAPSEC_POKEMON_LEAGUE] = REGION_HOENN,
    [MAPSEC_ROCK_TUNNEL] = REGION_HOENN,
    [MAPSEC_SEAFOAM_ISLANDS] = REGION_HOENN,
    [MAPSEC_POKEMON_TOWER] = REGION_HOENN,
    [MAPSEC_POWER_PLANT] = REGION_HOENN,
    [MAPSEC_ONE_ISLAND] = REGION_HOENN,
    [MAPSEC_TWO_ISLAND] = REGION_HOENN,
    [MAPSEC_THREE_ISLAND] = REGION_HOENN,
    [MAPSEC_FOUR_ISLAND] = REGION_HOENN,
    [MAPSEC_FIVE_ISLAND] = REGION_HOENN,
    [MAPSEC_SEVEN_ISLAND] = REGION_HOENN,
    [MAPSEC_SIX_ISLAND] = REGION_HOENN,
    [MAPSEC_KINDLE_ROAD] = REGION_HOENN,
    [MAPSEC_TREASURE_BEACH] = REGION_HOENN,
    [MAPSEC_CAPE_BRINK] = REGION_HOENN,
    [MAPSEC_BOND_BRIDGE] = REGION_HOENN,
    [MAPSEC_THREE_ISLE_PORT] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_6] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_7] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_8] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_9] = REGION_HOENN,
    [MAPSEC_RESORT_GORGEOUS] = REGION_HOENN,
    [MAPSEC_WATER_LABYRINTH] = REGION_HOENN,
    [MAPSEC_FIVE_ISLE_MEADOW] = REGION_HOENN,
    [MAPSEC_MEMORIAL_PILLAR] = REGION_HOENN,
    ...
    [MAPSEC_TRAINER_TOWER] = REGION_HOENN,
    [MAPSEC_CANYON_ENTRANCE] = REGION_HOENN,
    [MAPSEC_SEVAULT_CANYON] = REGION_HOENN,
    [MAPSEC_TANOBY_RUINS] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_22] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_23] = REGION_HOENN,
    [MAPSEC_SEVII_ISLE_24] = REGION_HOENN,
    [MAPSEC_NAVEL_ROCK_FRLG] = REGION_HOENN,
    ...
    [MAPSEC_TRAINER_TOWER_2] = REGION_HOENN,
    [MAPSEC_DOTTED_HOLE] = REGION_HOENN,
    [MAPSEC_LOST_CAVE] = REGION_HOENN,
    [MAPSEC_PATTERN_BUSH] = REGION_HOENN,
    [MAPSEC_ALTERING_CAVE_FRLG] = REGION_HOENN,
    [MAPSEC_TANOBY_CHAMBERS] = REGION_HOENN,
    [MAPSEC_THREE_ISLE_PATH] = REGION_HOENN,
    [MAPSEC_TANOBY_KEY] = REGION_HOENN,
    [MAPSEC_BIRTH_ISLAND_FRLG] = REGION_HOENN,
    [MAPSEC_MONEAN_CHAMBER] = REGION_HOENN,
    [MAPSEC_LIPTOO_CHAMBER] = REGION_HOENN,
    [MAPSEC_WEEPTH_CHAMBER] = REGION_HOENN,
    [MAPSEC_DILFORD_CHAMBER] = REGION_HOENN,
    [MAPSEC_SCUFIB_CHAMBER] = REGION_HOENN,
    [MAPSEC_RIXY_CHAMBER] = REGION_HOENN,
    [MAPSEC_VIAPOIS_CHAMBER] = REGION_HOENN,
    ...
    [MAPSEC_MIRAGE_SPOT_PLAIN_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_PLAIN_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_WOODS_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_WOODS_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_ASH_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_ASH_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_DESERT_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_DESERT_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_TALLGRASS_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_TALLGRASS_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_ISLAND_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_ISLAND_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_BEACH_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_BEACH_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_CAVE_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_CAVE_B] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_SNOW_A] = REGION_HOENN,
    [MAPSEC_MIRAGE_SPOT_SNOW_B] = REGION_HOENN,
    [MAPSEC_SLATEPORT_MARKET] = REGION_HOENN,
    [MAPSEC_NAMELESS_CAVERN] = REGION_HOENN,
    [MAPSEC_LAKE_VALOR] = REGION_HOENN,
    [MAPSEC_CAVE_OF_VALOR] = REGION_HOENN,
    [MAPSEC_SOUTHERN_WILDS] = REGION_HOENN,
    [MAPSEC_DEWFORD_WOODS] = REGION_HOENN,
    [MAPSEC_VAJRA_DESERT] = REGION_HOENN,
    [MAPSEC_VAJRA_PYRAMID] = REGION_HOENN,
    [MAPSEC_VAJRA_VILLAGE] = REGION_HOENN,
    [MAPSEC_ROUTE_135] = REGION_HOENN,
    [MAPSEC_LUMI_VILLAGE] = REGION_HOENN,
    [MAPSEC_FROSTWARD_MOUNTAIN] = REGION_HOENN,
    [MAPSEC_FOGBOUND_LAKE] = REGION_HOENN,
    [MAPSEC_ACUITY_CAVE] = REGION_HOENN,
    [MAPSEC_NEWMOON_ISLAND] = REGION_HOENN,
    [MAPSEC_FULLMOON_ISLAND] = REGION_HOENN,
    [MAPSEC_STARK_MOUNTAIN] = REGION_HOENN,
    [MAPSEC_CERULEAN_CAVE] = REGION_HOENN,
    [MAPSEC_FLOWER_PARADISE] = REGION_HOENN,
    [MAPSEC_DEWFORD_DOJO] = REGION_HOENN
};

u8 GetRegionFromMapSecId(u16 mapSecId)
{

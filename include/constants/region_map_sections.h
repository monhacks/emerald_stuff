...
#define MAPSEC_LAKE_VALOR                   0xD6
#define MAPSEC_CAVE_OF_VALOR                0xD7
#define MAPSEC_NAMELESS_CAVERN              0xD8
#define MAPSEC_SOUTHERN_WILDS               0xD9
#define MAPSEC_NORTHERN_WILDS               0xDA
